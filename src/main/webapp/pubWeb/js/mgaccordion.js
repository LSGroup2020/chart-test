    ...
    $.fn.mgaccordion = function (options) {
            ...
            $.each(this.find('li'), function () {
                ...
                if ($this.children('ul').length) {
                    ...
                    if (theme === 'tree') {
                        ...
                        $this.children('a').append('<span class="toggler"> <i class="fas fa-chevron-down"></i></span>');
                    }
                }
            });
        ...
        var setIcons = function () {
            if (settings.theme === 'tree') {
                ...
                openIcon = '<span class="toggler"><i class="fas fa-chevron-down"></i></span>';
                closeIcon = '<span class="toggler"><i class="fas fa-chevron-up"></i></span>';
            }
        }
